...
var airpopRobust = function(ntimes: number, randlow: number, randhi: number, starttime: number,
  ...
  for (var i = 0; i < ntimes; i++) {
    ...
    for (var j = 0; j < _.random(8, 12); j++) {
      scene.at(wait + 's', ril, ["/s_new", "simplePitchShift", s.nextNodeID(), 1, group, "out", 0, "bufnum", popbufs[pop], "shift", (dir < 0 ? shiftDown : dir > 0 ? shiftUp : shiftRand)(j), "mul", 1.0 / Math.log(j + 3)], randy);
